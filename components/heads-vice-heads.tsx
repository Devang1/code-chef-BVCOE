  ...
  const departments = [
    {
      ...
      head2: {
        name: "Samarth Chawla",
        role: "Technical Head",
        image: "/development/samarth.jpeg", // Example image path
      },
      viceHead: {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto px-4">
            Leading specialized teams across different domains with expertise
            and passion
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="grid gap-4 md:gap-6 sm:grid-cols-2">
                ...
                <motion.div
                  ...
                  onHoverStart={() => setHoveredMember("head")}
                  onHoverEnd={() => setHoveredMember(null)}
                  className="group relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl md:rounded-3xl p-4 md:p-6 border border-gray-700 hover:border-primary/50 transition-all duration-200 shadow-2xl hover:shadow-primary/20"
                >
                  {/* Profile Image */}
                  <div className="relative mb-4 md:mb-6 flex justify-center">
                    ...
                    >
                      ...
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: hoveredMember === "head" ? 1 : 0 }}
                  ...
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: hoveredMember === "head" ? 1 : 0 }}
                    transition={{ duration: 0.12, ease: "easeOut" }}
                ...
                {departments[activeTab].head2 && (
                  <motion.div
                    ...
                    onHoverStart={() => setHoveredMember("head2")}
                    onHoverEnd={() => setHoveredMember(null)}
                    className="group relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl md:rounded-3xl p-4 md:p-6 border border-gray-700 hover:border-primary/50 transition-all duration-200 shadow-2xl hover:shadow-primary/20"
                  >
                    {/* Profile Image */}
                    <div className="relative mb-4 md:mb-6 flex justify-center">
                      ...
                      >
                        ...
                        <motion.div
                          initial={{ scale: 0 }}
                          animate={{ scale: hoveredMember === "head2" ? 1 : 0 }}
                          transition={{ duration: 0.12, ease: "easeOut" }}
                          className="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-6 h-6 md:w-8 md:h-8 bg-primary rounded-full flex items-center justify-center shadow-lg"
                        >
                          <Star className="w-3 h-3 md:w-4 md:h-4 text-white" />
                    ...
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: hoveredMember === "head2" ? 1 : 0 }}
                      transition={{ duration: 0.12, ease: "easeOut" }}
                      className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent rounded-2xl md:rounded-3xl pointer-events-none"
                    />
                  </motion.div>
                ...
                <motion.div
                  ...
                  onHoverStart={() => setHoveredMember("viceHead")}
                  onHoverEnd={() => setHoveredMember(null)}
                  className="group relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl md:rounded-3xl p-4 md:p-6 border border-gray-700 hover:border-purple-500/50 transition-all duration-200 shadow-2xl hover:shadow-purple-500/20"
                >
                  {/* Profile Image */}
                  <div className="relative mb-4 md:mb-6 flex justify-center">
                    <motion.div
                    ...
                    >
                      ...
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{
                          scale: hoveredMember === "viceHead" ? 1 : 0,
                        }}
                        transition={{ duration: 0.12, ease: "easeOut" }}
                  ...
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: hoveredMember === "viceHead" ? 1 : 0 }}
                    transition={{ duration: 0.12, ease: "easeOut" }}
